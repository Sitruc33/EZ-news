The bundle.js and index.html are the only things you need to run the website. Index.js is the underlying code that Webpack uses as a source/entry point. 
